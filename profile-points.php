                            	...
                            	<div class="row">
                                	<div class="col-lg-3">
                                    	<div class="profile-dp">
                                        	<figure><img src="images/resources/profile-dp2.jpg" alt=""></figure>
                                    ...
                                    <div class="col-lg-9">
                                    	<div class="profile-points">
                                            ...
                                            <div class="earn-points">
                                            	<a href="#" title=""><i class="fa fa-share-alt"></i>earn points</a>
                                            </div>
                                        </div>
                                        <div class="top-space50">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="cola-box">
                                                        <i class="fa fa-star-o"></i>
                                                        <h5>Car East points</h5>
                                                        <p>When your friends share a trip or rent using Car East</p>
                                                        <a href="#" title="" class="theme-btn long">invite friends</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="cola-box">
                                                        ...
                                                        <p>Learn more about how Car East points work.</p>
                                                        <a href="#" title="" class="theme-btn long">find out more</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
